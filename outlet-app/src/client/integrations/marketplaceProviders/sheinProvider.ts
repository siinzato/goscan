// Adaptador Shein — inerte nesta etapa (sem credenciais configuradas
...
const MSG = "Integração com Shein ainda não configurada.";

export const sheinProvider: MarketplaceProvider = {
  key: "marketplace_shein",
